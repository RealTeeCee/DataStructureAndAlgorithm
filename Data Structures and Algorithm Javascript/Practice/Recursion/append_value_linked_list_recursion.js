...
export default class LinkedList {
  ...
  append(value, head) {
    ...
    //   return head;
    // } else {
    //   head = this.append(value, head.next);
    //   return head;
    // }
    if (head === null) {
      let obj = new Node(value);
      ...
      head.next = this.append(value, head.next);
      return head;
    }
  }
...
newLinkedList.append(1, newLinkedList.head);
newLinkedList.append(2, newLinkedList.head);
newLinkedList.append(3, newLinkedList.head);
