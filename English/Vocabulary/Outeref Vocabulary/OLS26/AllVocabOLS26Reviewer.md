...
(v) Thay lốp xe: 
(v) Sửa chữa tổng thể: 
(v) Thực hiện sửa chữa toàn bộ hệ thống hoặc động cơ. Ex: He had his car undergo a complete overhaul. (Anh ấy đã cho xe của mình trải qua một lần sửa chữa toàn bộ)
(v) Bị thủng lốp: 
(n) Va li: 
(n) Tiểu hành tinh: 
(n) Thể giả định: 
...
Ex: He used sunblock to prevent getting sunburned at the beach. (Anh ấy sử dụng sunblock để tránh bị cháy nắng khi ở bãi biển)
